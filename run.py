...
from paperpilot_common.middleware.server.auth import AuthMiddleware
from paperpilot_common.middleware.server.trace import TraceMiddleware
from paperpilot_common.utils.log import get_logger

import server.apps.im.urls as im
...
async def serve(addr: str | None = None) -> None:
    ...
    service_names = []
    service_names.extend(im.grpc_hook(server))
...
def main():
    init_logging()
    init_trace("paperpilot-backend-im")
