...
from paperpilot_common.grpc.signals import grpc_got_request_exception, grpc_request_finished, grpc_request_started
...
class SignalWrapper:
    ...
    def _replace_method_handler(self, method_handler: "RpcMethodHandler") -> "RpcMethodHandler":
        ...
        """
        kwargs = {prop: getattr(method_handler, prop) for prop in method_handler._fields}
