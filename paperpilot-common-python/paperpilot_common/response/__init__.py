...
class ResponseType(ResponseTypeEnum):
    ...
    TokenInvalid = ("A0221", "token 无效", 401)
    TokenExpired = ("A0222", "token 过期", 401)
    RefreshTokenInvalid = ("A0222", "refresh token 无效", 401)
    RefreshTokenExpired = ("A0223", "refresh token 过期", 401)
