...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals["_AUTHPUBLICSERVICE"]._serialized_start = 517
    _globals["_AUTHPUBLICSERVICE"]._serialized_end = 833
