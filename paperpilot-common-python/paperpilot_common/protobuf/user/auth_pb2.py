...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals["_AUTHPUBLICSERVICE"]._serialized_start = 480
    _globals["_AUTHPUBLICSERVICE"]._serialized_end = 731
